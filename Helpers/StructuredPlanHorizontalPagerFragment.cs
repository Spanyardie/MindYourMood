...
{
    public class StructuredPlanHorizontalPagerFragment : Fragment
    {
        private int _pageSelected = -1;

        private HorizontalInfiniteCycleViewPager _horizontalInfiniteCycleViewPager;
        public StructuredPlanHorizontalPagerFragment() { }
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            _horizontalInfiniteCycleViewPager.Adapter = new StructuredPlanHorizontalPagerAdapter(this, Context);
