...
namespace com.spanyardie.MindYourMood.Helpers
{
    public class ResourcesHorizontalPagerFragment : Fragment
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            _horizontalInfiniteCycleViewPager.Adapter = new ResourcesHorizontalPagerAdapter(this, Context);
