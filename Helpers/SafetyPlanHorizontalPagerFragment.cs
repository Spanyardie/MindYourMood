...
namespace com.spanyardie.MindYourMood.Helpers
{
    public class SafetyPlanHorizontalPagerFragment : Fragment
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            _horizontalInfiniteCycleViewPager.Adapter = new SafetyPlanHorizontalPagerAdapter(this, Context);
