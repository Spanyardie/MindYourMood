...
{
    [Activity]
    public class StopSuicideActivity : AppCompatActivity, IGenericTextCallback, IAlertCallback
    {
        public static string TAG = "M:StopSuicideActivity";
        ...
        {
            MenuInflater.Inflate(Resource.Menu.StopSuicideMenu, menu);
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            try
            {
                ...
                SetContentView(Resource.Layout.StopSuicideLayout);

                GetFieldComponents();

                CheckMicPermission();

                _toolbar = ToolbarHelper.SetupToolbar(this, Resource.Id.stopSuicideToolbar, Resource.String.safetyPlanStopActOnSuicidalThoughtsActivityTitle, Color.White);

                _imageLoader = ImageLoader.Instance;

                _imageLoader.LoadImage
                (
                    "drawable://" + Resource.Drawable.stopmyselfmain,
            ...
            catch (Exception e)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorCreatingStopSuicideActivity), "StopSuicideActivity.OnCreate");
            }
        }
        ...
        private void GenericList_ItemLongClick(object sender, AdapterView.ItemLongClickEventArgs e)
        {
            try
            {
                ...
                GenericTextDialogFragment genFragment = new GenericTextDialogFragment(this, "Edit item", GetString(Resource.String.stopSuicideGenericTextDialogTitle), genericTextItem.TextValue, selectedIndexID);
            ...
            catch(Exception ex)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorStopSuicideEditEntry), "StopSuicideActivity.GenericList_ItemLongClick");
            }
        }
        ...
        private void SetActionIcons(IMenu menu)
        {
            try
            {
                ...
                var itemAdd = menu.FindItem(Resource.Id.stopsuicideActionAdd);
                var itemRemove = menu.FindItem(Resource.Id.stopsuicideActionRemove);
                var itemHelp = menu.FindItem(Resource.Id.stopSuicideActionHelp);
            ...
            catch(Exception e)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, "Setting Action Icons", "StopSuicideActivity.SetActionIcons");
            }
        }
        ...
        {
            _genericList = FindViewById<ListView>(Resource.Id.lstSuicideList);
        ...
        private void Add()
        {
            try
            {
                _genericText = new GenericTextDialogFragment(this, "Stop Suicide", GetString(Resource.String.stopSuicideGenericTextDialogTitle));
            ...
            catch (Exception ex)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorAddingStopSuicideItem), "StopSuicideActivity.Add_Click");
            }
        }
        ...
        private void Remove()
        {
            try
            {
                if (_selectedItemIndex != -1)
                {
                    ...
                    alertHelper.AlertTitle = GetString(Resource.String.stopSuicideRemoveTitle);
                    alertHelper.AlertMessage = GetString(Resource.String.stopSuicideRemoveQuestion);
                    alertHelper.AlertIconResourceID = Resource.Drawable.SymbolStop;
                    alertHelper.AlertPositiveCaption = GetString(Resource.String.stopSuicideRemoveConfirm);
                    alertHelper.AlertNegativeCaption = GetString(Resource.String.stopSuicideRemoveCancel);
                ...
                else
                {
                    ...
                    {
                        var itemList = GlobalData.GenericTextItemsList.FindAll(item => item.TextType == ConstantsAndTypes.GENERIC_TEXT_TYPE.StopSuicidalThoughts);
                        if(itemList != null && itemList.Count > 0)
                        {
                            Toast.MakeText(this, Resource.String.StopSuicideToastSelectItem, ToastLength.Short).Show();
                        }
                        else
                        {
                            Toast.MakeText(this, Resource.String.StopSuicideToastNoItems, ToastLength.Short).Show();
                        }
                    }
                    else
                    {
            ...
            catch (Exception ex)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorRemovingStopSuicideEntry), "StopSuicideActivity.Remove_Click");
            }
        }
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            if (item != null)
            {
                ...
                switch (item.ItemId)
                {
                    case Resource.Id.stopsuicideActionAdd:
                        Add();
                        return true;

                    case Resource.Id.stopsuicideActionRemove:
                        Remove();
                        return true;

                    case Resource.Id.stopSuicideActionHelp:
        ...
        private void UpdateAdapter()
        {
            try
            {
                GenericTextListAdapter adapter = new GenericTextListAdapter(this, ConstantsAndTypes.GENERIC_TEXT_TYPE.StopSuicidalThoughts);
                if (_genericList != null)
            ...
            catch (Exception e)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorUpdatingStopSuicideDisplay), "StopSuicideActivity.UpdateAdapter");
            }
        }
        ...
        public void ConfirmText(string textEntered, int genericTextID)
        {
            try
            {
                ...
                genericText.TextType = ConstantsAndTypes.GENERIC_TEXT_TYPE.StopSuicidalThoughts;
                ...
                Toast.MakeText(this, Resource.String.stopSuicideConfirmTextToast, ToastLength.Short).Show();
            }
            catch (Exception e)
            {
                Log.Error(TAG, "ConfirmText: Exception - " + e.Message);
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorAddingStopSuicideItem), "StopSuicideActivity.ConfirmText");
            }
        }

        public void CancelText()
        {
            Toast.MakeText(this, Resource.String.stopSuicideCancelTextToast, ToastLength.Short).Show();
        }
        ...
        public void AlertPositiveButtonSelect(object sender, DialogClickEventArgs e, string instanceId)
        {
            ...
            if (_selectedItemIndex != -1)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorRemovingStopSuicideEntry), "StopSuicideActivity.AlertPositiveButtonSelect");
                }
            }
        }
        ...
        private void CheckMicPermission()
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, "Checking Microphone permission", "StopSuicideActivity.CheckMicPermission");
            }
        }
        ...
        public override void OnRequestPermissionsResult(int requestCode, string[] permissions, [GeneratedEnum] Permission[] grantResults)
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, "Processing permission result", "StopSuicideActivity.OnRequestPermissionsResult");
            }
        }
        ...
        private void ShowPermissionRationale()
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorMicPermissionShowRationalAlert), "StopSuicideActivity.ShowPermissionRationale");
            }
        }
        ...
        public void AttemptPermissionRequest()
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, "Attempting permission request", "StopSuicideActivity.AttemptPermissionRequest");
            }
        }
    }
}