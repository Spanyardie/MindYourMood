...
{
    [Activity]
    public class HowToCalmActivity : AppCompatActivity, IGenericTextCallback, IAlertCallback
    {
        public static string TAG = "M:HowToCalmActivity";
        ...
        {
            MenuInflater.Inflate(Resource.Menu.HowToCalmMenu, menu);
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            try
            {
                ...
                SetContentView(Resource.Layout.HowToCalmLayout);

                GetFieldComponents();

                CheckMicPermission();

                _toolbar = ToolbarHelper.SetupToolbar(this, Resource.Id.howToCalmToolbar, Resource.String.safetyPlanKeepCalmActivityTitle, Color.White);

                _imageLoader = ImageLoader.Instance;

                _imageLoader.LoadImage
                (
                    "drawable://" + Resource.Drawable.calmness,
            ...
            catch (Exception e)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorCreatingHowToCalmActivity), "HowToCalmActivity.OnCreate");
            }
        }
        ...
        private void GenericList_ItemLongClick(object sender, AdapterView.ItemLongClickEventArgs e)
        {
            try
            {
                ...
                GenericTextDialogFragment genFragment = new GenericTextDialogFragment(this, "Edit item", GetString(Resource.String.howToCalmGenericTextDialogTitle), genericTextItem.TextValue, selectedIndexID);
            ...
            catch(Exception ex)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorHowToCalmEditEntry), "HowToCalmActivity.GenericList_ItemLongClick");
            }
        }
        ...
        private void SetActionIcons(IMenu menu)
        {
            ...
            catch(Exception e)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, "Setting Action Icons", "HowToCalmActivity.SetActionIcons");
            }
        }
        ...
        {
            _genericList = FindViewById<ListView>(Resource.Id.lstKeepCalmList);
        ...
        private void Add()
        {
            ...
            catch (Exception ex)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorAddingHowToCalmEntry), "HowToCalmActivity.Add_Click");
            }
        }
        ...
        private void Remove()
        {
            try
            {
                if (_selectedItemIndex != -1)
                {
                    ...
                    alertHelper.AlertTitle = GetString(Resource.String.howToCalmRemoveTitle);
                    alertHelper.AlertMessage = GetString(Resource.String.howToCalmRemoveQuestion);
                    alertHelper.AlertIconResourceID = Resource.Drawable.SymbolStop;
                    alertHelper.AlertPositiveCaption = GetString(Resource.String.howToCalmRemoveConfirm);
                    alertHelper.AlertNegativeCaption = GetString(Resource.String.howToCalmRemoveCancel);
                ...
                else
                {
                    ...
                    {
                        var itemList = GlobalData.GenericTextItemsList.FindAll(item => item.TextType == ConstantsAndTypes.GENERIC_TEXT_TYPE.KeepCalm);
                        if (itemList != null && itemList.Count > 0)
                        {
                            Toast.MakeText(this, Resource.String.KeepCalmToastSelectItem, ToastLength.Short).Show();
                        }
                        else
                        {
                            Toast.MakeText(this, Resource.String.KeepCalmToastNoItems, ToastLength.Short).Show();
                        }
                    }
                    else
                    {
            ...
            catch (Exception ex)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorRemovingHowToCalmItem), "HowToCalmActivity.Remove_Click");
            }
        }
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            if (item != null)
            {
                ...
                switch (item.ItemId)
                {
                    case Resource.Id.howtocalmActionAdd:
                        Add();
                        return true;

                    case Resource.Id.howtocalmActionRemove:
                        Remove();
                        return true;

                    case Resource.Id.howtocalmActionHelp:
        ...
        private void UpdateAdapter()
        {
            try
            {
                GenericTextListAdapter adapter = new GenericTextListAdapter(this, ConstantsAndTypes.GENERIC_TEXT_TYPE.KeepCalm);
                if (_genericList != null)
            ...
            catch (Exception e)
            {
                ...
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorUpdatingHowToCalmDisplay), "HowToCalmActivity.UpdateAdapter");
            }
        }
        ...
        public void ConfirmText(string textEntered, int genericTextID)
        {
            try
            {
                ...
                genericText.TextType = ConstantsAndTypes.GENERIC_TEXT_TYPE.KeepCalm;
                ...
                Toast.MakeText(this, Resource.String.howToCalmConfirmTextToast, ToastLength.Short).Show();
            }
            catch (Exception e)
            {
                Log.Error(TAG, "ConfirmText: Exception - " + e.Message);
                if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorAddingHowToCalmEntry), "HowToCalmActivity.ConfirmText");
            }
        }

        public void CancelText()
        {
            Toast.MakeText(this, Resource.String.howToCalmCancelTextToast, ToastLength.Short).Show();
        }
        ...
        public void AlertPositiveButtonSelect(object sender, DialogClickEventArgs e, string instanceId)
        {
            ...
            if (_selectedItemIndex != -1)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if(GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, ex, GetString(Resource.String.ErrorRemovingHowToCalmItem), "HowToCalmActivity.AlertPositiveButtonSelect");
                }
            }
        }
        ...
        private void CheckMicPermission()
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, "Checking Microphone permission", "HowToCalmActivity.CheckMicPermission");
            }
        }
        ...
        public override void OnRequestPermissionsResult(int requestCode, string[] permissions, [GeneratedEnum] Permission[] grantResults)
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, "Processing permission result", "HowToCalmActivity.OnRequestPermissionsResult");
            }
        }
        ...
        private void ShowPermissionRationale()
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, GetString(Resource.String.ErrorMicPermissionShowRationalAlert), "HowToCalmActivity.ShowPermissionRationale");
            }
        }
        ...
        public void AttemptPermissionRequest()
        {
            ...
            catch (Exception e)
            {
                ...
                ErrorDisplay.ShowErrorAlert(this, e, "Attempting permission request", "HowToCalmActivity.AttemptPermissionRequest");
            }
        }
    }
}