...
{
    [Activity()]
    public class SafetyPlanSuicidalThoughtsHelpActivity : AppCompatActivity
    {
        public static string TAG = "M:SafetyPlanSuicidalThoughtsHelpActivity";
        ...
        {
            MenuInflater.Inflate(Resource.Menu.SuicidalThoughtsHelpMenu, menu);
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            if (item != null)
            {
                ...
                switch (item.ItemId)
                {
                    case Resource.Id.safetyPlanSuicidalThoughtsHelpActionHome:
        ...
        private void SetActionIcons(IMenu menu)
        {
            try
            {
                ...
                var itemHome = menu.FindItem(Resource.Id.safetyPlanSuicidalThoughtsHelpActionHome);
            ...
            catch (Exception e)
            {
                ...
                if (GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, "Setting Action Icons", "SafetyPlanSuicidalThoughtsHelpActivity.SetActionIcons");
            }
        }
    }
}