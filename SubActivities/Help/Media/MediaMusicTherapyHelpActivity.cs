...
{
    [Activity()]
    public class MediaMusicTherapyHelpActivity : AppCompatActivity
    {
        public static string TAG = "M:MediaMusicTherapyHelpActivity";
        ...
        {
            MenuInflater.Inflate(Resource.Menu.MusicTherapyHelpMenu, menu);
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            if (item != null)
            {
                ...
                switch (item.ItemId)
                {
                    case Resource.Id.mediaMusicTherapyHelpActionHome:
        ...
        private void SetActionIcons(IMenu menu)
        {
            try
            {
                ...
                var itemHome = menu.FindItem(Resource.Id.mediaMusicTherapyHelpActionHome);
            ...
            catch (Exception e)
            {
                ...
                if (GlobalData.ShowErrorDialog) ErrorDisplay.ShowErrorAlert(this, e, "Setting Action Icons", "MediaMusicTherapyHelpActivity.SetActionIcons");
            }
        }
    }
}